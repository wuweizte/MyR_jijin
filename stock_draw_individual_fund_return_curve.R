...
lines(x = draw.label.month,
      y = ts.result.zhan, 
      type = "o")
text(max(draw.label.month) + 0.27, tail(ts.result.zhan, 1) - 0.2 , 
     "展博1期（陈锋）", cex = 0.9)
...
lines(x = draw.label.month,
      ...
      type = "o", 
      col = "brown")
text(max(draw.label.month) + 0.29, tail(ts.result.jinglin, 1) + 0.2 , 
...
lines(x = draw.label.month,
      ...
      type = "o", 
      col = "purple")
text(max(draw.label.month) + 0.3, tail(ts.result.qing, 1) - 0.8  , 
...
lines(x = draw.label.month,
      ...
      type = "o", 
      col = "darkgreen")
text(max(draw.label.month) + 0.33, tail(ts.result.shang, 1) + 0.9  , 
...
lines(x = draw.label.month,
      ...
      lty = "dashed", 
      lwd = 2)
text(max(draw.label.month) + 0.33, tail(ts.result.quantile, 1) , 
